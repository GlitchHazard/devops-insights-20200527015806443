...
function AppContainer(props) {
    ...
    const handleZipChange = async (zipValue) => {
        ...
        const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?appid=6b7b471967dd0851d0010cdecf28f829&units=imperial&q=${zipValue},{},{NZ},us&units=metric`)
